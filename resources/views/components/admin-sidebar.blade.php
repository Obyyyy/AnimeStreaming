<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            {{-- Overview --}}
            <x-menu-link href="{{ route('admin.dashboard') }}" :active="request()->is('admin/dashboard')">
            ...
            {{-- Pages --}}
            <x-menu-link href="{{ route('admin.admins') }}" :active="request()->is('admin/dashboard/admins')">
                <svg aria-hidden="true"
                ...
                <span class="flex-1 ml-3 text-left whitespace-nowrap">Admins</span>
            </x-menu-link>
            {{-- Sales --}}
            <x-menu-link href="{{ route('admin.animes') }}" :active="request()->is('admin/dashboard/animes')">
                <svg aria-hidden="true"
