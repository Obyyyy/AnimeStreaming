<x-admin-layout>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('admin.animes') }}" method="GET">
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.form.add.animes') }}">
                            <button type="button"
                                class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Date Aired</th>
                            ...
                            @foreach ($animes as $index => $anime)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        {{ $anime->title }}</th>
                                    <td class="px-4 py-3">{{ Str::limit($anime->description, 50, '...') }}</td>
                                    <td class="px-4 py-3">{{ $anime->type }}</td>
                                    <td class="px-4 py-3">{{ $anime->studios }}</td>
                                    <td class="px-4 py-3">{{ $anime->date_aired }}</td>
                                    <td class="px-4 py-3">{{ $anime->status }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="dropdown-{{ $index }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.form.edit.animes', $anime->slug) }}"
                                                        class="flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg
                                                            class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" fill="none"
                                            ...
                                            <div class="py-1">
                                                <form id="delete-form-{{ $index }}"
                                                    action="{{ route('admin.delete.animes', $anime->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    @foreach ($animes as $index => $course)
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Delete confirmation</h3>
