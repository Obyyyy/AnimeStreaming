            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('admin.admins') }}" method="GET">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" name="search"
                                    ...
                                    placeholder="Search for Admin by name" required="">
                            </div>
                            <div
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.form.admins') }}">
                            <button type="button"
                                class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="dropdown-{{ $index }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.form.edit.admins', $admin->email) }}"
                                            ...
                                            <div class="py-1">
                                                <form action="{{ route('admin.delete.admins', $admin->email) }}"
                                                    ...
                                                    <button id="delete-button-{{ $index }}" type="button"
                                                        ...
                                                        class="flex items-center w-full text-left py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"><svg
                                                            class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" fill="none"
                                                            viewBox="0 0 24 24">
