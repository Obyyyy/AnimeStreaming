            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('admin.genres') }}" method="GET">
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.form.add.genres') }}">
                            <button type="button"
                                class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Has Animes</th>
                        ...
                        <tbody>
                            @foreach ($genres as $index => $genre)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $genre->animes->count() }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="dropdown-{{ $index }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.form.edit.genres', $genre->slug) }}"
                                            ...
                                            <div class="py-1">
                                                <form action="{{ route('admin.delete.genres', $genre->slug) }}"
