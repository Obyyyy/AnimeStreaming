...
Route::prefix('anime')->group(function()
{
    ...
    Route::post('/{anime:slug}/comment', [AnimeController::class, 'addComment'])->middleware(['isLogin'])->name('anime.add.comment');

    Route::post('/{anime:slug}/follow', [AnimeController::class, 'followAnime'])->middleware(['isLogin'])->name('anime.follow');

    Route::post('/{anime:slug}/unfollow', [AnimeController::class, 'unfollowAnime'])->middleware(['isLogin'])->name('anime.unfollow');
